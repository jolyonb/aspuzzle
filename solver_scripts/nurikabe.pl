...
:- region(C, A_1), region(C, A_2), A_1 != A_2.
...
regionless_anchor(Cmin) :- Cmin = #min{ Cell : regionless(Cell) }.
...
:- clue(C, N), region_size(C, Size), N != Size.

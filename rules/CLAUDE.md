...
`drafts/` holds write-ups for puzzle types not yet implemented. Several of
them were already solved in hand-written clingo in this project's
predecessor; `drafts/legacy-encodings.md` says which, and where those
encodings and their sourced example puzzles live.
